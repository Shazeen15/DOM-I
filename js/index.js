...
textContent.querySelector("h4").textContent =
  siteContent["main-content"]["features-h4"];
textContent.querySelector("p").textContent =
  siteContent["main-content"]["features-content"];

//about section
let textContent2 = topContent.querySelector(".text-content:nth-child(2)");
textContent2.querySelector("h4").textContent =
  siteContent["main-content"]["about-h4"];
textContent2.querySelector("p").textContent =
...
textContent3.querySelector("h4").textContent =
  siteContent["main-content"]["services-h4"];
textContent3.querySelector("p").innerHTML =
  siteContent["main-content"]["services-content"];

//product section
let textContent4 = bottomContent.querySelector(".text-content:nth-child(2)");
textContent4.querySelector("h4").innerHTML =
  siteContent["main-content"]["product-h4"];
textContent4.querySelector("p").innerHTML =
  siteContent["main-content"]["product-content"];

//vision section
let textContent5 = bottomContent.querySelector(".text-content:last-child");
textContent5.querySelector("h4").innerHTML =
  siteContent["main-content"]["vision-h4"];
textContent5.querySelector("p").innerHTML =
